...
#define pInst_RESET    (*(unsigned int *)(0x40000000 + 0x00))
#define pInst_UNDEF    (*(unsigned int *)(0x40000000 + 0x04))
#define pInst_SWI      (*(unsigned int *)(0x40000000 + 0x08))
#define pInst_PABORT   (*(unsigned int *)(0x40000000 + 0x0c))
#define pInst_DABORT   (*(unsigned int *)(0x40000000 + 0x10))
#define pInst_IRQ      (*(unsigned int *)(0x40000000 + 0x18))
#define pInst_FIQ      (*(unsigned int *)(0x40000000 + 0x1c))

/* Pointers to the jump addresses that are used after an exception
   (valid both for vectors in FLASH and RAM) */
#define pISR_RESET     (*(unsigned int *)(0x40000000 + 0x20))
#define pISR_UNDEF     (*(unsigned int *)(0x40000000 + 0x24))
#define pISR_SWI       (*(unsigned int *)(0x40000000 + 0x28))
#define pISR_PABORT    (*(unsigned int *)(0x40000000 + 0x2c))
#define pISR_DABORT    (*(unsigned int *)(0x40000000 + 0x30))
#define pISR_IRQ       (*(unsigned int *)(0x40000000 + 0x34))
#define pISR_FIQ       (*(unsigned int *)(0x40000000 + 0x38))
